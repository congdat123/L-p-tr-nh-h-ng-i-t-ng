      ...
      <div class="row text-center">
        <div class="col-sm-4">
          <div class="contact-detail-box">
            ...
            Fb <a href="https://www.facebook.com/nhahangtaidanangtochuctieccuoidanang" class="text-muted">Nhà Hàng Gia Hân</a>
          </div>
        </div><!-- end col -->
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="contact-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.122013784535!2d108.22080531468404!3d16.059156988887118!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314219c4867c90d5%3A0xbd2a918860de5eea!2zTmjDoCBow6BuZyBUaeG7h2MgY8aw4bubaSBHaWEgSMOibg!5e0!3m2!1svi!2s!4v1639555404379!5m2!1svi!2s" width="500" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
          </div>
        </div><!-- end col -->
          ...
          <form role="form" name="ajax-form" id="ajax-form"   @submit.prevent="AddCustomerSP" method="post" class="form-main">
            ...
            <div class="row">            
              <div class="col-xs-12">
                ...
                <button type="submit" class="btn btn-primary btn-shadow btn-rounded w-md" id="send">Gủi</button>
              </div> <!-- /col -->
            </div> <!-- /row -->
